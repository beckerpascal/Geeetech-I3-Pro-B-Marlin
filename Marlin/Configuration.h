...
#define STRING_CONFIG_H_AUTHOR "PBecker"                         // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "Hallo :)"            // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Pi3h Pro B"
